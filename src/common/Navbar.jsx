            ...
            <div className="container-fluid fixed-top">
                ...
                <div className="container px-0">
                    <nav className="navbar navbar-light bg-white navbar-expand-xl">
                        <Link  to="/" className="navbar-brand"><h1 className="text-primary display-6">Paradise Nursery</h1></Link >
                            ...
                            <div className="navbar-nav mx-auto">
                                ...
                                <div className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu m-0 bg-secondary rounded-0">
                                        <Link className="dropdown-item">Flowers</Link>
                                        <Link className="dropdown-item">Snake Plants</Link>
                                        <Link className="dropdown-item">Cactus</Link>
                                        <Link className="dropdown-item">Bayan Trees</Link>
                                    </div>
                                </div>
